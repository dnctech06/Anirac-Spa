    ...
    >
      ...
      {info === true && (
        <section className="valores">
          <h2>Laser System - Radiofrequência</h2>
          <div className="discription">
            <p>Rosto</p><pre> </pre>  <p>{v50}</p>
          </div>
          <div className="discription">
          ...
          <div className="discription">
            <p>Pernas (Coxas)</p><pre> </pre>  <p>{v65}</p>
          </div>
          <div className="discription">
          ...
          {/* Rejuvenescimento */}
          <h4>Laser System - Rejuvenescimento</h4>
          <div className="discription">
            <p>Rosto</p><pre> </pre> <p>{v40}</p>
          </div>
          <div className="discription">
            <p>Colo</p> <pre> </pre> <p>{v35}</p>
          </div>
          <div className="discription">
            <p>Mãos</p><pre> </pre>  <p>{v30}</p>
          </div>
          {/* PÈS */}
          <h4>Laser System - Laser Pedicure</h4>
          <div className="discription">
            <p>Sessão 2 pés</p><pre> </pre> <p>{v50}</p>
          </div>
        </section>
      )}
      ...
      {info === true && (
        <section className="valores">
          ...
          <h4>Laser System - Mulher</h4>
          <div className="discription">
            <p>Buço</p><pre> </pre>  <p>{v14}</p>
          </div>
          <div className="discription">
            <p>Entre Sobrancelhas</p><pre> </pre>  <p>{v14}</p>
          </div>
          <div className="discription">
            <p>Magas do Rosto</p><pre> </pre>  <p>{v15}</p>
          </div>
          <div className="discription">
            <p>Patilhas</p><pre> </pre>  <p>{v15}</p>
          </div>
          <div className="discription">
          ...
          <div className="discription">
            <p>Rosto Total</p><pre> </pre>  <p>{v40}</p>
          </div>
          <div className="discription">
          ...
          <div className="discription">
            <p>Linha Alba</p><pre> </pre>  <p>{v15}</p>
          </div>
          <div className="discription">
          ...
          <div className="discription">
            <p>Maõs ou Pés</p><pre> </pre>  <p>{v20}</p>
          </div>
          <div className="discription">
            <p>Glúteos + Zona Perianal</p><pre> </pre>  <p>{v40}</p>
          </div>
          <div className="discription">
      ...
      {info === true && (
        <section className="valores">
          <h2>Depilação a Laser</h2>
          <h4>Laser System - Homem</h4>
          <div className="discription">
            <p>Entre Sobrancelhas</p><pre> </pre>  <p>{v15}</p>
          </div>
          <div className="discription">
            <p>Maças do Rosto</p> <pre> </pre> <p>{v20}</p>
          </div>
          <div className="discription">
            <p>Patilhas</p><pre> </pre>  <p>{v20}</p>
          </div>
          <div className="discription">
            <p>Orelhas</p> <pre> </pre> <p>{v15}</p>
          </div>
          <div className="discription">
            <p>Narinas</p><pre> </pre>  <p>{v15}</p>
          </div>
          <div className="discription">
            <p>Bigode </p><pre> </pre>  <p>{v20}</p>
          </div>
          <div className="discription">
            <p>Pescoço Trás ou Frente</p><pre> </pre>  <p>{v25}</p>
          </div>
          <div className="discription">
            <p>Rosto Completo</p><pre> </pre>  <p>{v55}</p>
          </div>
          <div className="discription">
            <p>Axilas</p><pre> </pre>  <p>{v30}</p>
          </div>
          <div className="discription">
            <p>Ombros</p><pre> </pre> <p>{v30}</p>
          </div>
          <div className="discription">
            <p>Dorsal</p><pre> </pre>  <p>{v40}</p>
          </div>
          <div className="discription">
          ...
          <div className="discription">
            <p>Glúteos + Zona Perianal</p><pre> </pre> <p>{v60}</p>
          </div>
          <div className="discription">
            <p>Zona Perianal</p><pre> </pre>  <p>{v35}</p>
          </div>
          <div className="discription">
